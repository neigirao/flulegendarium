  ...
  return (
    <div style={{ fontFamily: 'Inter, -apple-system, sans-serif', background: '#F7F5F2', color: '#1a1a2e', overflowX: 'hidden' }}>
      <SEOManager
        ...
        description="Quem é o maior treinador da história do Fluminense? Analisamos 15 técnicos — Diniz, Abel Braga, Renato Gaúcho, Zezé Moreira e mais — com 5 critérios. Descubra o vencedor."
