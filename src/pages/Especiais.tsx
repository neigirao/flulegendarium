...
const SPECIALS: SpecialCard[] = [
  ...
  },
  {
    ...
    description: 'Analisamos 14 técnicos tricolores com metodologia exclusiva — 4 critérios, 90+ anos de história — para descobrir quem foi o treinador mais importante de todos os tempos.',
    badge: 'Estudo Especial',
    icon: '📋',
    color: '#006140',
  },
