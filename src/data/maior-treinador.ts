...
export const ITF_COACHES: ITFCoach[] = [
  ...
  },
  {
    ...
    empates: 21,
    derrotas: 27,
    legenda: 'Ídolo eterno como jogador (557 jogos), Telê Santana voltou ao Maracanã como treinador entre 1987 e 1989. Com 58,2% de aproveitamento em 98 jogos, preparou o Fluminense para a virada dos anos 90 antes de construir sua lenda máxima no São Paulo.',
    classicos: {
      Flamengo: { v: 3, e: 2, d: 2 },
      Vasco:    { v: 3, e: 2, d: 2 },
      Botafogo: { v: 3, e: 2, d: 2 },
    ...
    titulos_raw: {},
    campanhas_raw: {},
    premios: ['58,2% de aproveitamento em 98 jogos', 'Ídolo histórico como jogador (557 jogos pelo Flu)', 'Treinou o Flu antes de conquistar 2× Libertadores pelo São Paulo (1992, 1993)'],
  ...
  },
  {
    ...
    titulos_raw: { carioca: 1, taca_guanabara: 1, copa_rio: 1 },
    campanhas_raw: {},
    premios: ['Campeão Carioca 1975 — a lendária "Máquina Tricolor" com Rivellino', 'Campeão Taça Guanabara 1975 (96.035 pagantes na final contra o América)', 'Campeão Taça Rio 1990 (1º da história do Flu)', '60% de aproveitamento em 126 jogos'],
  },
  {
    id: 'pinheiro',
    nome: 'Pinheiro',
    ...
    campanhas_raw: {},
    premios: ['Campeão Taça Guanabara 1971 (interino, 3×1 no Fla com hat-trick de Mickey)', '605 jogos como zagueiro — ídolo que virou técnico', '58% de aproveitamento em 115 jogos como treinador'],
  },
  {
    id: 'valdir-espinosa',
