...
export const ITF_COACHES: ITFCoach[] = [
  ...
  },
  {
    ...
    titulos_raw: { carioca: 1, taca_guanabara: 1, copa_rio: 1 },
    campanhas_raw: {},
    premios: ['Campeão Carioca 1975 — a lendária "Máquina Tricolor" com Rivellino', 'Campeão Taça Guanabara 1975 (96.035 pagantes na final contra o América)', 'Campeão Taça Rio 1990 (1º da história do Flu)', '~61% de aproveitamento em ~130 jogos'],
    dados_estimados: true,
  },
  {
    id: 'pinheiro',
