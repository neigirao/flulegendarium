...
export const ILF_PLAYERS: ILFPlayer[] = [
  {
    ...
    scores: { producao: 100, titulos: 72, campanhas: 70, classicos: 85, decisivos: 75, premiacoes: 90, longevidade: 85, legado: 100 },
  ...
  },
  {
    ...
    scores: { producao: 82, titulos: 90, campanhas: 85, classicos: 90, decisivos: 88, premiacoes: 84, longevidade: 85, legado: 96 },
  ...
  },
  {
    ...
    scores: { producao: 78, titulos: 98, campanhas: 100, classicos: 72, decisivos: 95, premiacoes: 96, longevidade: 55, legado: 88 },
  ...
  },
  {
    ...
    scores: { producao: 80, titulos: 68, campanhas: 63, classicos: 85, decisivos: 68, premiacoes: 60, longevidade: 75, legado: 78 },
  ...
  },
  {
    ...
    scores: { producao: 88, titulos: 82, campanhas: 70, classicos: 82, decisivos: 78, premiacoes: 62, longevidade: 52, legado: 75 },
  ...
  },
  {
    ...
    scores: { producao: 55, titulos: 80, campanhas: 75, classicos: 65, decisivos: 70, premiacoes: 58, longevidade: 100, legado: 90 },
  ...
  },
  {
    ...
    scores: { producao: 90, titulos: 75, campanhas: 68, classicos: 95, decisivos: 72, premiacoes: 72, longevidade: 50, legado: 85 },
  ...
  },
  {
    ...
    scores: { producao: 76, titulos: 82, campanhas: 70, classicos: 68, decisivos: 75, premiacoes: 58, longevidade: 68, legado: 70 },
  ...
  },
  {
    ...
    scores: { producao: 73, titulos: 62, campanhas: 70, classicos: 82, decisivos: 70, premiacoes: 88, longevidade: 52, legado: 92 },
  ...
  },
  {
    ...
    scores: { producao: 62, titulos: 80, campanhas: 78, classicos: 60, decisivos: 72, premiacoes: 52, longevidade: 75, legado: 82 },
  ...
  },
  {
    ...
    scores: { producao: 60, titulos: 45, campanhas: 75, classicos: 52, decisivos: 62, premiacoes: 48, longevidade: 68, legado: 72 },
  ...
  },
  {
    ...
    scores: { producao: 60, titulos: 38, campanhas: 40, classicos: 48, decisivos: 48, premiacoes: 40, longevidade: 65, legado: 58 },
  ...
  },
  {
    ...
    scores: { producao: 55, titulos: 68, campanhas: 65, classicos: 55, decisivos: 62, premiacoes: 44, longevidade: 65, legado: 65 },
  ...
  },
  {
    ...
    scores: { producao: 52, titulos: 70, campanhas: 65, classicos: 52, decisivos: 62, premiacoes: 42, longevidade: 65, legado: 62 },
  ...
  },
  {
    ...
    scores: { producao: 52, titulos: 62, campanhas: 58, classicos: 50, decisivos: 58, premiacoes: 40, longevidade: 62, legado: 55 },
    classicos: { Flamengo: 12, Vasco: 10, Botafogo: 8 },
