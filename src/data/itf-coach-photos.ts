...
// IDs usados no CMS (Supabase Storage → bucket "players")
...
export const ITF_PHOTOS: Record<string, string> = {
  ...
  'tele-santana':      'https://hafxruwnggitvtyngedy.supabase.co/storage/v1/object/public/players/player-1781102651542.png',
  ...
  'carlomagno':        'https://hafxruwnggitvtyngedy.supabase.co/storage/v1/object/public/players/player-1781102064948.jpg',
