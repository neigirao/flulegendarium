...
const BADGE_COLOR_T: Record<string, string> = {
  ...
  recopa: '#E8B560', carioca: '#AF1E35', rio_sp: '#64748B',
    ...
    <section style={{ background: 'white', padding: '72px 32px', borderTop: '1px solid #EDE8E0' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 14, color: '#475569', marginBottom: 30 }}>
          Cada conquista vale pontos diferentes: Mundial (200) · Libertadores (100) · Brasileiro (50) · Série C (50) · Copa do Brasil (40) · Recopa (20) · Carioca (15) · Rio-SP e Primeira Liga (5).
        </p>
