...
export const JerseyScoreDistribution = () => {
  const { data, isLoading } = useQuery({
    queryKey: ["public-jersey-score-distribution"],
    queryFn: async () => {
      const { data: rankings } = await supabase.from("jersey_game_rankings").select("score");
      ...
      return {
        ...
        narrative: `${pct}% dos jogadores marcam até 500 pontos no quiz de camisas.`,
      };
    },
