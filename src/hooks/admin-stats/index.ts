/**
 * Admin Statistics Hooks - Barrel Export
 * 
 * Centraliza todos os hooks relacionados a estatísticas e analytics para área admin.
 * 
 * @module hooks/admin-stats
 */
...
export { useOptimizedQueries } from './use-optimized-queries';
