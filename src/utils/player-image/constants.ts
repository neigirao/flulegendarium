...
export const playerImagesFallbacks: Record<string, string> = {
  ...
  "Germán Cano": "/lovable-uploads/0aa3609f-0584-4bf4-8303-e03f50f7e131.png", // Temporário - usar imagem padrão
  "Cano": "/lovable-uploads/0aa3609f-0584-4bf4-8303-e03f50f7e131.png", // Temporário - usar imagem padrão
